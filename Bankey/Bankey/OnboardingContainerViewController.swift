...
//  Bankey
//
//  Created by Raghuram on 11/06/24.
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page2 = OnboardingViewController(heroImageName: "world", titleText: "Bankey is faster, easier to use, and has a brand new look and feel that will make you feel like you are back in 1989")
        let page3 = OnboardingViewController(heroImageName: "thumbs", titleText: "Bankey is faster, easier to use, and has a brand new look and feel that will make you feel like you are back in 1989")
